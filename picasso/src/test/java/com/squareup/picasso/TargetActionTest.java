...
public class TargetActionTest {
  ...
  public void throwsErrorWithNullResult() throws Exception {
    TargetAction request =
        new TargetAction(mock(Picasso.class), mockTarget(), null, false, false, 0, null, URI_KEY_1);
  ...
  public void invokesSuccessIfTargetIsNotNull() throws Exception {
    ...
    TargetAction request =
        new TargetAction(mock(Picasso.class), target, null, false, false, 0, null, URI_KEY_1);
  ...
  public void invokesOnBitmapFailedIfTargetIsNotNullWithErrorDrawable() throws Exception {
    ...
    Target target = mockTarget();
    TargetAction request =
        new TargetAction(mock(Picasso.class), target, null, false, false, 0, errorDrawable, URI_KEY_1);
    request.error();
  ...
  public void invokesOnBitmapFailedIfTargetIsNotNullWithErrorResourceId() throws Exception {
    ...
    TargetAction request =
        new TargetAction(picasso, target, null, false, false, RESOURCE_ID_1, null, URI_KEY_1);
  ...
  @Test public void recyclingInSuccessThrowsException() {
    ...
    TargetAction tr = new TargetAction(picasso, bad, null, false, false, 0, null, URI_KEY_1);
    try {
