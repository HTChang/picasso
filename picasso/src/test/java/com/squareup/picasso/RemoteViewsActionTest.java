...
public class RemoteViewsActionTest {
  ...
  private TestableRemoteViewsAction createAction(int errorResId) {
    return new TestableRemoteViewsAction(picasso, null, remoteViews, 1, errorResId, false, false, false,
        URI_KEY_1);
  }

  private Picasso createPicasso() {
    return new Picasso(Robolectric.application, mock(Dispatcher.class), Cache.NONE, Cache.NONE,
        null, IDENTITY, mock(Stats.class), false, false);
  }
  ...
  static class TestableRemoteViewsAction extends RemoteViewsAction {
    TestableRemoteViewsAction(Picasso picasso, Request data, RemoteViews remoteViews, int viewId,
        int errorResId, boolean fromCacheOnly, boolean skipCache, boolean skipDiskCache, String key) {
      super(picasso, data, remoteViews, viewId, errorResId, fromCacheOnly, skipCache, skipDiskCache, key);
    }
