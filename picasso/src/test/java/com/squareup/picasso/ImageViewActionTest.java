...
public class ImageViewActionTest {
  ...
  public void throwsErrorWithNullResult() throws Exception {
    ImageViewAction action =
        new ImageViewAction(mock(Picasso.class), mockImageViewTarget(), null, false, false, false, false, 0, null,
            URI_KEY_1, null);
  ...
  public void returnsIfTargetIsNullOnComplete() throws Exception {
    ...
    ImageViewAction request =
        new ImageViewAction(picasso, target, null, false, false, false, false, 0, null, URI_KEY_1, callback);
  ...
  public void invokesTargetAndCallbackErrorIfTargetIsNotNullWithErrorResourceId() throws Exception {
    ...
    ImageViewAction request =
        new ImageViewAction(mock, target, null, false, false, false, false, RESOURCE_ID_1, null, null, callback);
    request.error();
  ...
  public void invokesErrorIfTargetIsNotNullWithErrorDrawable() throws Exception {
    ...
    Picasso mock = mock(Picasso.class);
    ImageViewAction request =
        new ImageViewAction(mock, target, null, false, false, false, false, 0, errorDrawable, URI_KEY_1,
            callback);
    request.error();
